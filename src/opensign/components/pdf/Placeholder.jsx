...
function Placeholder(props) {
  ...
  const handleOnClickSettingIcon = () => {
    // Set current widget details first
    if (props.setCurrWidgetsDetails) {
    ...
    //condition to handle setting icon for signyour-self flow for all type text widgets
      ...
      console.log("Opening name modal for widget type:", props.pos.type);
        ...
        <>
          ...
          {props.pos.type === "date" && selectDate && (
            <i
              ...
              className="fa-solid fa-gear icon"></i>
          )}
          ...
          <i
            ...
            style={{ color: "#188ae2", right: "12px", top: "-18px" }}></i>
          ...
          <i
            ...
            style={{ color: "#188ae2", right: "-8px", top: "-18px" }}></i>
        </>
      )
    );
  };
          ...
          {props.pos.key === props?.currWidgetsDetails?.key &&
            (props.isShowBorder ||
              ...
              <div
                ...
                className="w-[calc(100%+21px)] h-[calc(100%+21px)] cursor-move absolute inline-block border-[1px] border-dashed"></div>
            )}
          <div
