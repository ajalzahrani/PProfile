            ...
            {props?.isCompleted || props?.alreadySign ? (
              <DropdownMenu.Root>
                <DropdownMenu.Trigger asChild>
                  <div className="text-blue-600 hover:text-blue-800 no-underline text-[16px] font-semibold px-3 cursor-pointer transition-colors duration-200">
                    <i
                ...
                */}
                  ...
                  <div className="flex items-center" data-tut="reactourFifth">
                    ...
                    {props?.isPlaceholder ? (
                      <div
                        ...
                        } no-underline font-[650] text-[14px] cursor-pointer transition-colors duration-200`}
                        data-tut="headerArea">
                      ...
                      <div
                        ...
                        className="border-none font-[650] text-[14px] text-blue-600 hover:text-blue-800 no-underline cursor-pointer transition-colors duration-200">
                        {t("finish")}
                      </div>
                    )}
                    <input
                ...
                {props?.isPublicTemplate && (
                  <div
                    data-tut="reactourThird"
                    onClick={() => props?.embedWidgetsData()}
                    className="border-none font-[650] text-[14px] pr-2 text-blue-600 hover:text-blue-800 no-underline cursor-pointer transition-colors duration-200">
                    {t("sign-now")}
                  </div>
                )}
              </div>
          ...
          {props?.isPlaceholder ? (
              ...
              <div className="flex">
                ...
                {enabledBackBtn && (
                  <button
                    ...
                    type="button"
                    className="px-3 py-1 border border-gray-300 bg-white hover:bg-gray-50 text-gray-700 hover:text-gray-900 rounded-md transition-colors duration-200 mr-[3px]">
                    {t("back")}
                  </button>
                )}
                <button
                  ...
                  data-tut="headerArea"
                  className="px-3 py-1 bg-blue-600 hover:bg-blue-700 disabled:bg-gray-400 disabled:cursor-not-allowed text-white rounded-md transition-colors duration-200 mr-[3px]"
              ...
              <div className="flex" data-tut="reactourFifth">
                {props?.currentSigner && (
                  <>
                    ...
                    {!props?.isSelfSign && (
                      <button
                        className="px-3 py-1 border border-gray-300 bg-white hover:bg-gray-50 text-gray-700 hover:text-gray-900 rounded-md transition-colors duration-200 mr-[3px] shadow"
                        onClick={() => handleDeclinePdfAlert()}>
                        {t("decline")}
                      </button>
                    )}
                    ...
                    <button
                      type="button"
                      className="px-3 py-0 bg-blue-600 hover:bg-blue-700 text-white rounded-md transition-colors duration-200 mr-[3px] shadow"
                      onClick={() => props?.embedWidgetsData()}>
                      {t("finish")}
                    </button>
                  </>
            ...
            <div className="flex flex-row">
              {props?.isCompleted && (
                <button
                  ...
                  className="px-3 py-1 bg-blue-600 hover:bg-blue-700 text-white rounded-md transition-colors duration-200 mr-[3px] shadow">
              ...
              <button
                type="button"
                className="px-3 py-0 border border-gray-300 bg-white hover:bg-gray-50 text-gray-700 hover:text-gray-900 rounded-md transition-colors duration-200 mr-[3px] shadow"
                onClick={() => props?.setIsEmail(true)}>
            ...
            <div className="flex">
              <button
                onClick={() => window.history.go(-2)}
                type="button"
                className="px-3 py-0 border border-gray-300 bg-white hover:bg-gray-50 text-gray-700 hover:text-gray-900 rounded-md transition-colors duration-200 mr-[3px]">
                {t("back")}
              </button>
              <button
                type="button"
