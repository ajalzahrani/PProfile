      ...
      <form
        ...
        {!["signature", "initials"].includes(props.defaultdata?.type) && (
          <div className="mb-[0.75rem] text-[13px]">
            ...
            <input
              className="border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 hover:border-gray-400 w-full text-xs px-3 py-2 bg-white"
              name="name"
              value={formdata.name}
            ...
            <div className="mb-[0.75rem]">
              ...
              {isValid === false && (
                <div
                  ...
                  style={{ fontSize: 12 }}>
                  <i
                    className="fa-solid fa-exclamation-circle text-[15px]"
                    style={{ color: "#fab005" }}></i>
              ...
              {statusArr.map((data, ind) => {
                return (
                  <div
                    ...
                    <input
                      className="mr-[2px] w-4 h-4 text-blue-600 border-gray-300 focus:ring-blue-500"
                      type="radio"
                      name="status"
                      onChange={() =>
              ...
              {signatureType.map((type, i) => {
                return (
                  <div key={i} className="flex flex-row gap-[5px] items-center">
                    <input
                      className="mr-[2px] w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                      type="checkbox"
                      name="signaturetype"
        ...
        {[
          ...
          <div className="flex flex-col md:flex-row md:items-center gap-3 mb-3">
            <div className="flex items-center gap-2 ">
              ...
              <select
                className="ml-[7px] w-[60%] border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 hover:border-gray-400 text-xs px-3 py-2 bg-white"
                value={
            ...
            <div className="flex items-center">
              ...
              <select
                ...
                className="ml-[33px] md:ml-4 w-[65%] md:w-[full] border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 hover:border-gray-400 text-xs px-3 py-2 bg-white">
              ...
              <span
                ...
                className="w-5 h-[19px] ml-1"></span>
            </div>
          </div>
        )}
