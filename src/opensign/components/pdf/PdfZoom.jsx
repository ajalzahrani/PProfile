        ...
        {!props.isDisableEditTools && (
          <>
            <span
              ...
              />
              <i className="fa-solid fa-plus text-gray-500 2xl:text-[25px]"></i>
            </span>
            <span
              className="bg-gray-50 px-[4px]  2xl:py-[10px] cursor-pointer"
              onClick={() => setIsDeletePage(true)}
              title={t("delete-page")}>
              <i className="fa-solid fa-trash text-gray-500 2xl:text-[25px]"></i>
            </span>
            <span
              className="bg-gray-50 px-[4px]  2xl:py-[10px] cursor-pointer"
              onClick={() => setIsReorderModal(true)}
              title={t("reorder-pages")}>
              <i className="fa-solid fa-list-ol text-gray-500 2xl:text-[25px]"></i>
            </span>
          </>
        )}
        <span
          ...
          title={t("zoom-in")}>
          <i className="fa-solid fa-magnifying-glass-plus text-gray-500 2xl:text-[25px]"></i>
        </span>
        ...
        {!props.isDisableEditTools && (
          <>
            <span
              ...
              <i className="fa-solid fa-rotate-right text-gray-500 2xl:text-[25px]"></i>
            </span>
            <span
              className="bg-gray-50 px-[4px] 2xl:py-[10px] cursor-pointer"
              title={t("rotate-left")}
              onClick={() => props.handleRotationFun(-90)}>
              <i className="fa-solid fa-rotate-left text-gray-500 2xl:text-[25px]"></i>
            </span>
          </>
        )}
        <span
